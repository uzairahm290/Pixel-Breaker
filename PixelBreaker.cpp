#include<iostream>
#include<conio.h>
#include"HelperGraphics.h"     //Graphics Library 
#include<fstream>
using namespace std;
...
restart:
	...
	cout << "\t\t"
		...
		<< "\t\t"
		<< "\\______   \\|__|___  ___  ____  |  |   \\______   \\_______   ____  _____   |  | __  ____ _______ \n"
		<< "\t\t"
		<< " |     ___/|  | \\  \\/  /_/ __ \\ |  |    |    |  _/\\_  __ \\_/ __ \\ \\__  \\  |  |/ /_/ __ \\\\_  __ \\\n"
		<< "\t\t"
		<< " |    |    |  |  >    < \\  ___/ |  |__  |    |   \\ |  | \\//  ___/  / __ \\_|    < \\  ___/ |  | \\/\n"
		<< "\t\t"
		<< " |____|    |__| /__/\\_ \\ \\___  >|____/  |______  / |__|    \\___  >(____  /|__|_ \\ \\___  >|__|   \n"
		<< "\t\t"
		<< "                     \\/     \\/                \\/              \\/      \\/      \\/     \\/        \n\n";
	cout << "\t\t\t\t  BREAK BRICKS BY BOUNCING A BALL OFF A BOTTOM PADDLE TO SCORE POINTS\n\n\n";
	...
	cout << "  Press ' R ' for RESTART GAME\n\n\n";
	cout << "  CREATED BY : UZAIR AHMAD (23L-0594)\n\n\n";
	...
	while (1) {
		...
		jump:
			...
			while (1) {
				...
				if (e_size[3] >= 598) {
					if (e_size[0] <= bar2 && e_size[1] >= bar1) {
						...
						if (life > 0) {
							...
							cout << "\n\n\t\t\t\t\t\t::::::::SCORE IS:::::::" << score;
							cout << "\n\n\n\n\n\n\n\n\n";
							cout << "\t\t  ________    _____      _____   ___________       ________ ____   _________________________  \n";
							cout << "\t\t /  _____/   /  _  \\    /     \\  \\_   _____/       \\_____  \\\\   \\ /   /\\_   _____/\\______   \\ \n";
							cout << "\t\t/   \\  ___  /  /_\\  \\  /  \\ /  \\  |    __)_         /   |   \\\\   Y   /  |    __)_  |       _/ \n";
							cout << "\t\t\\    \\_\\  \\/    |    \\/    Y    \\ |        \\       /    |    \\\\     /   |        \\ |    |   \\ \n";
				...
				if (input == 's' || input == 'S') {
					...
					cout <<
						"\n\n\n\n\n\n\n"
						"\t  ________    _____      _____   ___________         _________   _____ ____   _______________________\n"
						"\t /  _____/   /  _  \\    /     \\  \\_   _____/        /   _____/  /  _  \\\\   \\ /   /\\_   _____/\\______ \\\n"
						"\t/   \\  ___  /  /_\\  \\  /  \\ /  \\  |    __)_         \\_____  \\  /  /_\\  \\\\   Y   /  |    __)_  |    |  \\\n"
						"\t\\    \\_\\  \\/    |    \\/    Y    \\ |        \\        /        \\/    |    \\\\     /   |        \\ |    `   \\\n"
						"\t \\______  /\\____|__  /\\____|__  //_______  /       /_______  /\\____|__  / \\___/   /_______  //_______  /\n"
						"\t        \\/         \\/         \\/         \\/                \\/         \\/                  \\/         \\/\n";
					cout << "\n\n\n\n\n\n\n\n";
		...
		if (score >= 7150) {
			...
			std::cout <<
				"\n\n\n\n"
				"\t\t"
				"_________  ________    _______     __________________    _____ ___________ _________ \n"
				"\t\t"
				"\\_   ___ \\ \\_____  \\   \\      \\   /  _____/\\______   \\  /  _  \\\\__    ___//   _____/ \n"
				"\t\t"
				"/    \\  \\/  /   |   \\  /   |   \\ /   \\  ___ |       _/ /  /_\\  \\ |    |   \\_____  \\  \n"
				"\t\t"
				"\\     \\____/    |    \\/    |    \\\\    \\_\\  \\|    |   \\/    |    \\|    |   /        \\ \n"
				"\t\t"
				" \\______  /\\_______  /\\____|__  / \\______  /|____|_  /\\____|__  /|____|  /_______  / \n"
				"\t\t"
				"        \\/         \\/         \\/         \\/        \\/         \\/                 \\/  \n"
				"\t\t\t"
				" _____.___.                      __      __ ________    _______               \n"
				"\t\t\t"
				" \\__  |   |  ____   __ __       /  \\    /  \\\\_____  \\   \\      \\              \n"
				"\t\t\t"
				"  /   |   | /  _ \\ |  |  \\      \\   \\/\\/   //   |   \\  /   |   \\             \n"
				...
				"  \\____   |(  <_> )|  |  /       \\        / \\    |    \\/    |    \\            \n"
				"\t\t\t"
				"  / ______| \\____/ |____/         \\__/\\  /   \\_______  /\\____|__  /            \n"
				"\t\t\t"
				"  \\/                                   \\/            \\/         \\/             \n\n\n\n";
			cout << "\n";
			cout << "Press 'R' to restart or 'Q' to Quit : ";
